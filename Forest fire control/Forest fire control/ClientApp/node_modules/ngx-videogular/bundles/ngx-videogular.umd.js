(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var VgControlsHidden = /** @class */ (function () {
         ...
         * @return {?}
         */
        VgControlsHidden.prototype.state = /**
         * @param {?} hidden
         * @return {?}
         */
        function (hidden) {
    ...
    var VgUtils = /** @class */ (function () {
        ...
        /** @nocollapse */ VgUtils.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function VgUtils_Factory() { return new VgUtils(); }, token: VgUtils, providedIn: "root" });
        return VgUtils;
    }());
    ...
    var VgFullscreen = /** @class */ (function () {
         ...
         * @return {?}
         */
        VgFullscreen.prototype.ngOnInit = /**
         * @return {?}
         */
        function () {
            var _this = this;
         ...
         * @return {?}
         */
        VgFullscreen.prototype.onPlayerReady = /**
         * @return {?}
         */
        function () {
            this.target = this.API.getMediaById(this.vgFor);
         ...
         * @return {?}
         */
        VgFullscreen.prototype.onChangeFullscreen = /**
         * @param {?} fsState
         * @return {?}
         */
        function (fsState) {
         ...
         * @return {?}
         */
        VgFullscreen.prototype.onClick = /**
         * @return {?}
         */
        function () {
         ...
         * @return {?}
         */
        VgFullscreen.prototype.onKeyDown = /**
         * @param {?} event
         * @return {?}
         */
        function (event) {
         ...
         * @return {?}
         */
        VgFullscreen.prototype.changeFullscreenState = /**
         * @return {?}
         */
        function () {
            /** @type {?} */
         ...
         * @return {?}
         */
        VgFullscreen.prototype.ngOnDestroy = /**
         * @return {?}
         */
        function () {
            this.subscriptions.forEach((/**
    ...
    var VgMute = /** @class */ (function () {
         ...
         * @return {?}
         */
        VgMute.prototype.onPlayerReady = /**
         * @return {?}
         */
        function () {
            this.target = this.API.getMediaById(this.vgFor);
         ...
         * @return {?}
         */
        VgMute.prototype.changeMuteState = /**
         * @return {?}
         */
        function () {
            /** @type {?} */
    ...
    var VgPlayPause = /** @class */ (function () {
         ...
         * @return {?}
         */
        VgPlayPause.prototype.ngOnInit = /**
         * @return {?}
         */
        function () {
            var _this = this;
         ...
         * @return {?}
         */
        VgPlayPause.prototype.onPlayerReady = /**
         * @return {?}
         */
        function () {
            this.target = this.API.getMediaById(this.vgFor);
         ...
         * @return {?}
         */
        VgPlayPause.prototype.onKeyDown = /**
         * @param {?} event
         * @return {?}
         */
        function (event) {
         ...
         * @return {?}
         */
        VgPlayPause.prototype.playPause = /**
         * @return {?}
         */
        function () {
            /** @type {?} */
         ...
         * @return {?}
         */
        VgPlayPause.prototype.getState = /**
         * @return {?}
         */
        function () {
         ...
         * @return {?}
         */
        VgPlayPause.prototype.ngOnDestroy = /**
         * @return {?}
         */
        function () {
            this.subscriptions.forEach((/**
    ...
    var VgPlaybackButton = /** @class */ (function () {
         ...
         * @return {?}
         */
        VgPlaybackButton.prototype.ngOnInit = /**
         * @return {?}
         */
        function () {
            var _this = this;
         ...
         * @return {?}
         */
        VgPlaybackButton.prototype.onPlayerReady = /**
         * @return {?}
         */
        function () {
            this.target = this.API.getMediaById(this.vgFor);
         ...
         * @return {?}
         */
        VgPlaybackButton.prototype.onClick = /**
         * @return {?}
         */
        function () {
         ...
         * @return {?}
         */
        VgPlaybackButton.prototype.onKeyDown = /**
         * @param {?} event
         * @return {?}
         */
        function (event) {
         ...
         * @return {?}
         */
        VgPlaybackButton.prototype.updatePlaybackSpeed = /**
         * @return {?}
         */
        function () {
         ...
         * @return {?}
         */
        VgPlaybackButton.prototype.getPlaybackRate = /**
         * @return {?}
         */
        function () {
         ...
         * @return {?}
         */
        VgPlaybackButton.prototype.ngOnDestroy = /**
         * @return {?}
         */
        function () {
            this.subscriptions.forEach((/**
    ...
    var VgScrubBarBufferingTime = /** @class */ (function () {
         ...
         * @return {?}
         */
        VgScrubBarBufferingTime.prototype.ngOnInit = /**
         * @return {?}
         */
        function () {
            var _this = this;
         ...
         * @return {?}
         */
        VgScrubBarBufferingTime.prototype.onPlayerReady = /**
         * @return {?}
         */
        function () {
            this.target = this.API.getMediaById(this.vgFor);
         ...
         * @return {?}
         */
        VgScrubBarBufferingTime.prototype.getBufferTime = /**
         * @return {?}
         */
        function () {
            /** @type {?} */
         ...
         * @return {?}
         */
        VgScrubBarBufferingTime.prototype.ngOnDestroy = /**
         * @return {?}
         */
        function () {
            this.subscriptions.forEach((/**
    ...
    var VgScrubBarCurrentTime = /** @class */ (function () {
         ...
         * @return {?}
         */
        VgScrubBarCurrentTime.prototype.ngOnInit = /**
         * @return {?}
         */
        function () {
            var _this = this;
         ...
         * @return {?}
         */
        VgScrubBarCurrentTime.prototype.onPlayerReady = /**
         * @return {?}
         */
        function () {
            this.target = this.API.getMediaById(this.vgFor);
         ...
         * @return {?}
         */
        VgScrubBarCurrentTime.prototype.getPercentage = /**
         * @return {?}
         */
        function () {
            return this.target ? ((this.target.time.current * 100) / this.target.time.total) + '%' : '0%';
         ...
         * @return {?}
         */
        VgScrubBarCurrentTime.prototype.ngOnDestroy = /**
         * @return {?}
         */
        function () {
            this.subscriptions.forEach((/**
    ...
    var VgQualitySelector = /** @class */ (function () {
         ...
         * @return {?}
         */
        VgQualitySelector.prototype.ngOnInit = /**
         * @return {?}
         */
        function () {
        };
         ...
         * @return {?}
         */
        VgQualitySelector.prototype.ngOnChanges = /**
         * @param {?} changes
         * @return {?}
         */
        function (changes) {
            if (changes['bitrates'].currentValue && changes['bitrates'].currentValue.length) {
                 ...
                 * @return {?}
                 */
                function (item) { return item.label = (item.label || Math.round(item.bitrate / 1000)).toString(); }));
            }
        };
        /**
         * @param {?} index
         * @return {?}
         */
        VgQualitySelector.prototype.selectBitrate = /**
         * @param {?} index
         * @return {?}
         */
        function (index) {
         ...
         * @return {?}
         */
        VgQualitySelector.prototype.ngOnDestroy = /**
         * @return {?}
         */
        function () {
            this.subscriptions.forEach((/**
    ...
    var VgMedia = /** @class */ (function () {
        ...
        function () {
            ...
            this.subscriptions = {
                ...
                startAds: rxjs.fromEvent((/** @type {?} */ (this.elem)), VgEvents.VG_START_ADS),
                endAds: rxjs.fromEvent((/** @type {?} */ (this.elem)), VgEvents.VG_END_ADS),
        ...
        function () {
            ...
            this.canPlayAllSubscription = rxjs.combineLatest(canPlayAll).pipe(operators.map((/**
             * @param {...?} params
             * @return {?}
             */
            function () {
        ...
        VgMedia.propDecorators = {
            vgMedia: [{ type: core.Input }],
            vgMaster: [{ type: core.Input }]
        };
        return VgMedia;
    }());
    if (false) {
    ...
    var VgCuePoints = /** @class */ (function () {
        ...
        VgCuePoints.propDecorators = {
            onEnterCuePoint: [{ type: core.Output }],
            onUpdateCuePoint: [{ type: core.Output }],
            onExitCuePoint: [{ type: core.Output }],
            onCompleteCuePoint: [{ type: core.Output }]
        };
        return VgCuePoints;
    }());
    if (false) {
    ...
    var VgPlayer = /** @class */ (function () {
        ...
        VgPlayer.propDecorators = {
            isFullscreen: [{ type: core.HostBinding, args: ['class.fullscreen',] }],
            isNativeFullscreen: [{ type: core.HostBinding, args: ['class.native-fullscreen',] }],
            areControlsHidden: [{ type: core.HostBinding, args: ['class.controls-hidden',] }],
            zIndex: [{ type: core.HostBinding, args: ['style.z-index',] }],
            onPlayerReady: [{ type: core.Output }],
            onMediaReady: [{ type: core.Output }],
            medias: [{ type: core.ContentChildren, args: [VgMedia,] }]
        };
        return VgPlayer;
    }());
    if (false) {
    ...
    var VgMediaElement = /** @class */ (function () {
         ...
         * @return {?}
         */
        VgMediaElement.prototype.addTextTrack = 
        // @ts-ignore
        /**
         * @param {?} kind
         * @param {?=} label
         ...
         * @return {?}
         */
        VgMediaElement.prototype.canPlayType = 
        // @ts-ignore
        /**
         * @param {?} type
         * @return {?}
         ...
         * @return {?}
         */
        VgMediaElement.prototype.msClearEffects = /**
         * @return {?}
         */
        function () {
        };
         ...
         * @return {?}
         */
        VgMediaElement.prototype.msGetAsCastingSource = /**
         * @return {?}
         */
        function () {
            return null;
         ...
         * @return {?}
         */
        VgMediaElement.prototype.msInsertAudioEffect = 
        // @ts-ignore
        /**
         * @param {?} activatableClassId
         * @param {?} effectRequired
         ...
         * @return {?}
         */
        function (activatableClassId, effectRequired, config) {
        };
        // @ts-ignore
        // @ts-ignore
        /**
         ...
         * @return {?}
         */
        VgMediaElement.prototype.msSetMediaKeys = 
        // @ts-ignore
        /**
         * @param {?} mediaKeys
         * @return {?}
         ...
         * @return {?}
         */
        VgMediaElement.prototype.msSetMediaProtectionManager = 
        // @ts-ignore
        /**
         * @param {?=} mediaProtectionManager
         * @return {?}
         ...
         * @return {?}
         */
        VgMediaElement.prototype.pause = /**
         * @return {?}
         */
        function () {
        };
         ...
         * @return {?}
         */
        VgMediaElement.prototype.setMediaKeys = 
        // @ts-ignore
        /**
         * @param {?} mediaKeys
         * @return {?}
         ...
         * @return {?}
         */
        VgMediaElement.prototype.addEventListener = 
        // @ts-ignore
        /**
         * @param {?} type
         * @param {?} listener
